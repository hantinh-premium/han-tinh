...
const L={
  tq:"Tổng quan",km:"Khách mới",ht:"Học thử",hv:"Học viên",hd:"Hợp đồng",
  bc:"Báo cáo",ls:"Lịch sử",tc:"Tài chính",bd:"Biểu đồ",ktn:"Khách tiềm năng",
  htinh:"Hán Tinh",dnhap:"Đăng nhập",dnht:"Đăng nhập hệ thống",
  tkh:"Tài khoản",mk:"Mật khẩu",saitk:"Sai tài khoản hoặc mật khẩu",
  them:"Thêm",themmoi:"Thêm mới",sua:"Chỉnh sửa",luu:"Lưu",huy:"Huỷ",
  xlich:"Xếp lịch",tao:"Tạo",thoat:"Thoát",xoa:"Xoá?",dk:"ĐK",gh:"Gia hạn",
  dthu:"Đã thu",nohp:"Nợ HP",cnhac:"Cần nhắc",hvlt:"HV lớp tôi",
  dtb:"Điểm TB",ccan:"Chuyên cần",hskdo:"HSK đỗ",
  cthu:"Cần thu",gday:"Gần đây",cxl:"cần xử lý",
  chiso:"Chỉ số",pheu:"Phễu",xhg:"Xu hướng",
  dthu2:"Doanh thu",thtoan:"Thanh toán",kqua:"Kết quả",
  tyle:"Tỷ lệ",nguon:"Nguồn",diem:"Điểm",
  ten:"Tên",sdt:"SĐT",nguonh:"Nguồn",lop:"Lớp",diemh:"Điểm",
  ngay:"Ngày",han:"Hạn",tong:"Tổng",con:"Còn",phi:"Phí",nhac:"Nhắc",gd:"GĐ",
  hoten:"Họ tên",nguonf:"Nguồn",qtam:"Quan tâm",gdoan:"Giai đoạn",
  gchu:"Ghi chú",tdo:"Trình độ",tthai:"Trạng thái",
  than:"Thời hạn",bdau:"Bắt đầu",kthuc:"Kết thúc",
  hphi:"Học phí",nthi:"Ngày thi",cthi:"Chưa thi",dat:"ĐẠT",
  cdat:"Chưa đạt",comat:"Có mặt",vang:"Vắng",hvvang:"HV vắng",
  bhoc:"Bài học",chuy:"Chú ý",nbat:"Nổi bật",ndung:"Nội dung",
  nguoi:"Người",loai:"Loại",boi:"Bởi",tphi:"Tổng phí",
  hdot2:"Hạn đợt 2",nlai:"Nhắc lại",hvien:"Học viên",gio:"Giờ",
  htham:"Hỏi thăm",hthu:"Học thử",dadk:"Đã ĐK",mat:"Mất",
  dhoc:"Đang học",tnghi:"Tạm nghỉ",nghih:"Nghỉ học",
  dxep:"Đã xếp",dahoc:"Đã học",kden:"Không đến",
  snghi:"Suy nghĩ",kqt:"Không QT",ddong:"Đã đóng",cho:"Chờ",
  qhan:"Quá hạn","3t":"3 tháng","6t":"6 tháng","12t":"12 tháng","18t":"18 tháng",
  gthieu:"Giới thiệu",goi:"Gọi",nhan:"Nhắn",gap:"Gặp",
  bhoi:"Hỏi",bthu:"Thử",bxep:"Xếp",bxong:"Xong",bkd:"KĐ",
  bnghi:"Nghĩ",bkqt:"KQT",bsap:"Sắp",bhet:"Hết",
  btruot:"Trượt",bchua:"Chưa",bdu:"Đủ",bno:"Nợ",bdatl:"Đạt",
  cohoa:"Cô Hoa",tlong:"Thầy Long",cowang:"Cô Wang Li",tnam:"Thầy Nam",
  tkiem:"Tìm kiếm...",dong:"đ"
};
...
function toApp(t,o){const m=FM[t];if(!m)return{...o};const rm={};for(const[k,v]of Object.entries(m))rm[v]=k;const r={};for(const[k,v]of Object.entries(o))r[rm[k]||k]=typeof v==="string"?decodeUnicodeText(v):v;return r}
...
function decodeUnicodeText(str){
  if(typeof str!=="string")return str;
  try{return str.replace(/\\u[\dA-Fa-f]{4}/g,m=>String.fromCharCode(parseInt(m.slice(2),16)))}catch{return str}
}
